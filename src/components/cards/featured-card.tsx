    ...
    <Link href={href}>
      ...
      >
        ...
        <div className="pl-4 md:pl-5 lg:pl-4 3xl:pl-6">
          ...
          <div className="uppercase text-xs xl:text-13px font-poppins font-semibold tracking-[0.6px] flex items-center text-skin-base text-opacity-60 transition duration-200 ease-in-out group-hover:text-opacity-100">
            {t("text-learn-more")}
