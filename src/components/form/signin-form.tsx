...
function SignInForm({ csrfToken }: any) {
  ...
  return (
    <div>
      <div className="xl:px-20 md:px-10 sm:px-6 px-4 md:py-2 py-4 2xl:mx-auto 2xl:container md:flex items-center justify-center">
        {/* <div className="lg:w-2/3 md:w-1/2 lg:ml-16 lg:mr-4 ml-8 md:mt-0 mt-6">
          <Image
            src="/images/hero/signin.webp"
            alt="signin image"
            // layout="fill"
            width={800}
            height={600}
        ...
        <div className="bg-white shadow-lg rounded lg:w-1/3 md:w-1/2 w-full lg:px-10 sm:px-6 sm:py-8 px-2 py-6">
          {/* <p
            tabIndex={0}
            className="focus:outline-none text-xl font-semibold uppercase leading-6 text-gray-800"
          >
            Login to Geenia
          </p> */}
          <p
          ...
          <button
            ...
            role="button"
            className="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 p-3 border rounded-lg border-gray-700 flex items-center w-full mt-6 hover:bg-gray-100"
          >
            <svg
              width={19}
              height={20}
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div>
              ...
              <input
                ...
                type="email"
                className="bg-gray-200 border rounded text-sm font-medium leading-none placeholder-gray-800 text-gray-800 py-3 w-full pl-3 "
              ...
              />
              {errors.email && (
                <p className="text-rose-700 text-sm">{errors.email?.message}</p>
              )}
            </div>
            <div className="mt-2 w-full">
              ...
              <div className="relative flex items-center justify-center">
                <input
                  ...
                  className="bg-gray-200 border rounded text-sm font-medium leading-none text-gray-800 py-3 w-full pl-3 "
                  {...register("password", {
