...
const SearchTopBar = ({ TotalProducts }: any) => {
  ...
  return (
    <div className="flex justify-between items-center mb-6">
      ...
      >
        <FilterIcon />
        <span className="pl-2.5">{t("text-filters")}</span>
      </button>
      <div className="flex w-full items-center justify-end lg:justify-between">
        <div className="flex-shrink-0 text-skin-base font-medium text-15px leading-4 md:mr-6 hidden lg:block mt-0.5">
