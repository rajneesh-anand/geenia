...
const backgroundThumbnail = "/images/about-us.png";
const aboutUs1 = "/images/about-us/1.png";
const aboutUs2 = "/images/about-us/2.png";
const aboutUs3 = "/images/about-us/3.png";
const aboutUs4 = "/images/about-us/4.png";
const aboutUs5 = "/images/about-us/5.png";
const aboutUs6 = "/images/about-us/6.png";
        ...
        <Container>
          <div className="flex flex-col w-full mx-auto max-w-[1200px]">
            ...
            <p className="text-skin-base font-medium text-base lg:text-lg leading-7 2xl:text-[20px] lg:leading-loose lg:mt-4 mb-3.5">
              ...
              <a href="mailto:press@geenia.in">press@geenia.in</a>.
            </p>
            <div
              className="text-skin-base opacity-70 text-sm leading-7 lg:text-15px lg:leading-loose"
              dangerouslySetInnerHTML={{
